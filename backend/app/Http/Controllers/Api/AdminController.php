...
use App\Events\NotificacionImportante;
...
class AdminController extends Controller
{
    ...
    public function createUser(Request $request)
    {
        try {
            ...
            // Notificación interna para profesores
            if ($request->role === 'profesor') {
                $mensaje = "¡Bienvenido a MindSchool!\n\nYa puedes ingresar a la plataforma y configurar tu disponibilidad de asesorías desde el menú 'Disponibilidad'. Si tienes dudas, contacta al administrador.";
                $user->notify(new \App\Notifications\NotificacionPersonalizada($mensaje));
            }
